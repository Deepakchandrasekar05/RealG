    ...
    return (
      <div className="space-y-6 p-4 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Construction Weather Intelligence</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs bg-blue-50 text-blue-600 px-2 py-1 rounded">
                    {forecastData[0]?.rainChance || '--'}% chance
                  </span>
                </div>
                <div className="flex items-end justify-between">
                  <h3 className="text-3xl font-bold">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-gray-500">
                      24h total: {sensorData.reduce((sum, d) => sum + d.rainfall, 0).toFixed(1)} mm
                    </p>
                  </div>
                </div>
                <div className="mt-4 h-16">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="flex items-end justify-between">
                  <div>
                    <h3 className="text-3xl font-bold">
                      {workerSafety?.recommendations.length || '--'}
                    </h3>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <div className="mt-3 text-xs text-gray-500">
                  Last updated: {craneStatus.lastUpdated}
                </div>
              </div>
            </div>
          </div>
